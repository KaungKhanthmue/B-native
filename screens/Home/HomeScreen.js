...
const HomeScreen = () => {
  ...
  return (
    <>
      ...
      {sidbar && (
        <View className="absolute z-20 w-[60%] right-0 h-full bg-black bg-opacity-50 rounded-l-xl mt-[9%]">
          <View className="flex-col w-full h-[5%]"></View>
        </View>
      )}
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="mt-2">
          <View className="flex-row justify-between w-full px-2">
            <Text className="text-lg text-black mt-1 ml-2">Popular X</Text>
